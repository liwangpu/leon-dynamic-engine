import { DynamicForm, SetterType } from '@lowcode-engine/component-configuration-shared';
import { GenerateNestedComponentId } from '@lowcode-engine/core';
import { distinctUntilChanged, map, Observable } from 'rxjs';
import { SubSink } from 'subsink';
import { ComponentTypes, PrimarySetterType, TableFeature, TableSelectionMode, TableSlot } from '../../enums';
